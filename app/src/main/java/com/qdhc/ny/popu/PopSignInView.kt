 ...
 * @date 2019/4/5
 */
class PopSignInView(private val mContext: Activity, private val mOnClicListener: onClickLisiner) : PopupWindow() {
    ...
    init {
        ...
        mViewGroup = LayoutInflater.from(mContext).inflate(
                R.layout.pop_sign, null) as ViewGroup
