...
public class GridImageShowAdapter extends RecyclerView.Adapter<GridImageShowAdapter.ViewHolder> {
    ...
    public GridImageShowAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.gv_filter_image_show,
                viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.drawable.common_ic_add_photo);
